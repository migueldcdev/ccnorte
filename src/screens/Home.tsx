        ...
        <div>
            ...
            <div className="flex justify-center">
                {location.state != null && location.state.validated == false &&
                   <div className="w-80 h-52 flex justify-center mx-auto mt-20 shadow rounded relative border border-1 border-rose-500">
                        <img src={location.state.image} alt="Uploaded image" width={250}/>                        
                    </div>
                }
                {location.state != null && location.state.validated == true &&
                   <div className="w-80 h-52 flex justify-center mx-auto mt-20 shadow rounded relative border border-1 border-lime-500">
                        <img src={location.state.image} alt="Uploaded image" width={250}/>                        
                    </div>
                }
